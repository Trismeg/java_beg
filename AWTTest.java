...
public class AWTTest extends Frame{
  ...
  // private int count = 0;     // Counter's value
   ...
   public AWTTest () {
      ...
      label = new Label("A Label");  // construct the Label component
      add(label);                    // "super" Frame adds Label
 
     // tfCount = new TextField("0", 40); // construct the TextField component
     ...
     // btnCount.addActionListener(this);
      ...
      setTitle("AWT Title");  // "super" Frame sets its title
